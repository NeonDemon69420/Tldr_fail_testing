...
with open('./results/vulnerable_ip_addresses.txt', 'r') as file:
...
with open("./results/classified_ip_addresses_overview.txt", "w") as file:
...
with open("./results/classified_ip_addresses.txt", "w") as file:
